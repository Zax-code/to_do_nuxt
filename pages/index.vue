...
<template>
    <div class="flex flex-col items-center">
        <div v-if="isLoading" class="absolute top-0 left-0 flex justify-center font-bold text-4xl items-center z-30 w-full h-full bg-black text-slate-50">LOADING...</div>
